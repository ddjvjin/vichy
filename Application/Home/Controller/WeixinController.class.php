...
class WeixinController extends Controller {
    ...
    { 
        ...
        $openid=cookie("openid_Vichy170918_14");
        ...
        if(empty($openid)){
            ...
            if(!empty($openid)){
                ...
                cookie('openid_Vichy170918_12',$openid,array('expire'=>3600*24)); 
            }else{
                getVichyOpenid();
                exit;
            }
        ...
        $shareList['image']="https://mmbiz.qlogo.cn/mmbiz_jpg/LQqk9YGMbYIMpddfQunN937Os8Qm4wK9Te2yib4jQARWCdvUNopiaRhQqHgUKc16wqY5M4uViaUaT5Oq5N3Q9cwRQ/0?wx_fmt=jpeg";
