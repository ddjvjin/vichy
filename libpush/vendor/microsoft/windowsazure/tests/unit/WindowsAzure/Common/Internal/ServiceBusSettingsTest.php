...
class ServiceBusSettingsTest extends \PHPUnit_Framework_TestCase
{
    ...
    public function testCreateFromConnectionStringWithServiceBusAutomaticCase()
    {
        ...
        $expectedServiceBusEndpoint = "https://$expectedNamespace.servicebus.chinacloudapi.cn";
        $expectedWrapName = 'myname';
        $expectedWrapPassword = 'mypassword';
        $expectedWrapEndpointUri = "https://$expectedNamespace-sb.accesscontrol.chinacloudapi.cn/WRAPv0.9";
    ...
    public function testGetWrapEndpointUri()
    {
        ...
        $expected = "https://$namespace-sb.accesscontrol.chinacloudapi.cn/WRAPv0.9";
